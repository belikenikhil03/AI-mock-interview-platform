// ai-interview-frontend/src/components/VideoTimeline.tsx
'use client';
  ...
  return (
    <div className="bg-gray-800 rounded-xl overflow-hidden border border-gray-700">
      ...
      <div className="relative bg-black">
        ...
        >
          <div className="w-20 h-20 bg-white/90 rounded-full flex items-center justify-center text-gray-900 text-3xl">
            {playing ? '⏸' : '▶'}
          </div>
        </button>
      </div>
              ...
              <div className="space-y-1">
                {group.events.map((event, eventIdx) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded text-xs hover:bg-gray-800 transition-colors flex items-center gap-2 ${getEventColor(event.severity)}`}
                  >
